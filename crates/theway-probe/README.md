...
该二进制在 [`build.rs`](build.rs) 中直接从 transport 拥有的 protobuf 定义编译 tonic 客户端，其中包括 [`health.proto`](../theway-transport/proto/health.proto)。这样既保持 probe 独立，也能测试 daemon 实际暴露的同一协议。
