impl App {
    fn render(&mut self, frame: &mut ratatui::Frame) {
        ...
        let chunks = Layout::vertical([
            Constraint::Min(1),
            Constraint::Length(1), // status rule / compact nine-dot indicator
        ...
        // Status rule: plain ready/offline rule when idle; a compact
        // single-row nine-dot rainbow snake while busy.
        if self.busy {
