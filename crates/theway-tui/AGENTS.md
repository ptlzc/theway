...
This file adds crate-specific instructions to [`../../AGENTS.md`](../../AGENTS.md). Read the [crate overview](README.md), [client/controller architecture](docs/architecture.md), and [daemon positioning rule](../../AGENTS.md#daemon-positioning) before changing interaction or startup behavior.

## Boundary rules

- Never add dependencies on `theway-core` or `theway-daemon`; use [`theway-transport`](../theway-transport/README.md) messages, clients, and operation traits.
