...
This file adds crate-specific instructions to [`../../AGENTS.md`](../../AGENTS.md). Read the [crate overview](README.md), [persistence architecture](docs/architecture.md), and leaf definitions in [`../theway-contract`](../theway-contract/README.md) before changing stored formats.
...
- Follow [`../../docs/rust-test-files.md`](../../docs/rust-test-files.md) for mirrored module suites.
