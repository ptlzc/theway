...
pub fn agent_ws_url(base_url: &str, view_token: &str) -> Result<String> {
...
/// token segment.
pub fn viewer_url(base_url: &str, view_token: &str) -> String {
...
pub fn qr_lines(url: &str) -> Result<Vec<String>> {
