...
async fn endpoints_return_state_accept_commands_and_stream_snapshots() {
    ...
    let router = web_router(HttpState {
        ...
        events: broadcast::channel::<theway_core::harness::subagents::registry::SubagentEvent>(16)
            .0,
        dag_events: broadcast::channel::<theway_core::harness::graph_engineering::types::DagEvent>(
            16,
        )
        .0,
        registry: theway_core::harness::subagents::registry::SubagentJobRegistry::new(),
    });
