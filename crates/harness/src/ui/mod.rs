...
pub struct AppConfig {
    ...
    pub dag_engine: std::sync::Arc<theway_core::harness::graph_engineering::engine::DagEngine>,
    /// Subagent job registry (graph mode). Task tool + DAG nodes register here.
    pub subagent_registry: theway_core::harness::subagents::registry::SubagentJobRegistry,
}
...
pub struct App {
    ...
    pub(crate) dag_engine:
        std::sync::Arc<theway_core::harness::graph_engineering::engine::DagEngine>,
    /// Subagent job registry (graph mode). Task tool + DAG nodes register here.
    pub(crate) subagent_registry: theway_core::harness::subagents::registry::SubagentJobRegistry,
...
mod tests {
    ...
    fn test_app_with_options(opts: AgentHarnessOptions) -> App {
        ...
        App::new(AppConfig {
            ...
            subagent_registry: theway_core::harness::subagents::registry::SubagentJobRegistry::new(
            ),
        })
    }
