...
pub(crate) fn sample_trigger(
    idempotency_key: &str,
    trace_id: &str,
) -> theway_daemon::trigger_engine::types::Trigger {
    theway_daemon::trigger_engine::types::Trigger {
        source: theway_daemon::trigger_engine::types::TriggerSource::Mcp {
            server_name: "github".into(),
            method: "notifications/pr.merged".into(),
        },
        source_kind: theway_daemon::trigger_engine::types::SourceKind::Mcp,
        source_label: "MCP github".into(),
        event_label: "pr merged".into(),
        payload_visibility: theway_daemon::trigger_engine::types::PayloadVisibility::Local,
        payload_summary: Some("PR #42 merged".into()),
        payload: None,
        idempotency_key: idempotency_key.into(),
        replacement_policy: theway_daemon::trigger_engine::types::ReplacementPolicy::Drop,
        trace_id: trace_id.into(),
        authority: theway_daemon::trigger_engine::types::TriggerAuthority {
            principal_id: "mcp:github".into(),
            principal_label: "github".into(),
            credential_scope: theway_daemon::trigger_engine::types::CredentialScope::Project,
