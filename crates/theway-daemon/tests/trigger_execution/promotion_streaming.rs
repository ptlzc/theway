...
async fn promote_while_parent_is_streaming_routes_through_follow_up_single_write() {
    ...
    before_trigger_action = Some({
        let hook: theway_daemon::trigger_engine::execution::BeforeTriggerActionHook = Arc::new(
            move |ctx: theway_daemon::trigger_engine::execution::BeforeTriggerActionContext,
                  _cancel| {
                Box::pin(async move {
                    theway_daemon::trigger_engine::execution::TriggerAction {
                        ...
                        promote:
                            theway_daemon::trigger_engine::execution::PromoteAction::PromoteSummaryNow {
                                template_body: None,
                            },
