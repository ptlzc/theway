...
/// (localized from the donor's `util` module so this crate stays
/// self-contained).
...
/// (localized from the donor's `util` module).
pub fn truncate_to_width(s: &str, max_width: usize) -> std::borrow::Cow<'_, str> {
