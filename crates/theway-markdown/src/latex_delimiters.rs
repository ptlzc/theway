...
include!(concat!(
    ...
    "/src/latex_delimiters/output.rs"
));

#[cfg(test)]
tests_bridge_macro::tests_bridge!("latex_delimiters/unit");

#[cfg(test)]
mod latex_stress_tests {
    tests_bridge_macro::tests_bridge!("latex_delimiters/stress");
}
