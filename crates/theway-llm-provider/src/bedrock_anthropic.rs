...
//! payload stream into theway-llm-provider's `AssistantMessageEvent` stream.
//!
...
/// partial-as-of-this-moment snapshot theway-llm-provider consumers expect.
...
tests_bridge_macro::tests_bridge!("bedrock_anthropic");
